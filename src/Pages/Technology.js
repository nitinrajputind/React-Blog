    ...
    <>
      ...
      <div className="TheLatest">
        ...
        <div className="Latest_contanier">
          {Apidata.filter((data) => data.category === "Technology" && data.id <= 35).map(
            (item, index) => {
              // console.log(item)
              return (
                <TheLatest
      ...
      {/* style={{width : "710px", border : "2px solid Blue"}} */}
        ...
        </h2>
        {
         ...
         Apidata.filter((data)=>data.category === "Technology" ).map((item, index)=>{
        ...
        {
         Apidata.filter((data)=>data.id % 3 === 0 && (data.category === "Hollywood" || data.category === "Food" )).map((item, index)=>{
          return(
            <TopPost key={index}
      ...
      <div className="Latest_contanier">
        {
          Apidata.filter((data)=>data.id % 2 === 0 && (data.category === "Technology" && data.id % 4 ===0)).map((item,index)=>{
            // console.log(item)
            return(
              <TextNews key={index}
              title = {item.title} 
